...
SMOKE_DATA = HERE / "artifact_rollout_smoke.npz"
FULL_DATA = HERE / "artifact_rollout_data.npz"
SMALL_WIDTH = 3.75
SMALL_HEIGHT = 2.2
PANEL_MARGIN = 1.0
...
def output_paths(data_path):
    ...
    return (
        HERE / f"artifact_diagnostics{suffix}.png",
        HERE / f"artifact_rollouts{suffix}.png",
    )
...
def build_rollout_figure(data, args):
    ...
    fig.suptitle("Artifact-propagation rollout snapshots", fontsize=13, y=args.title_closeness)
